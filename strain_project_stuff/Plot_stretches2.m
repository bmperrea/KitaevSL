...
fileName = ['stretch_flux_rmax_',num2str(round(rmax)),'_b_',num2str(round(b)),'_s_',num2str(1000*s)];
load(['../',fileName])
...
%     plot(Ev/2,normalate( II{2}(Tcinds(4),:) , 2/dE ),':','Color',[0.7, 0, 0]);
%     plot(Ev/2,normalate( II{2}(Tcinds(5),:) , 2/dE ),':','Color',[0.8, .3, 0.3]);
%     plot(Ev/2,normalate( II{2}(Tcinds(6),:) , 2/dE ), ':','Color',[0.9, 0.6, 0.6]);
%     plot(Ev/2,normalate( II{2}(numel(Tv),:) , 2/dE ),'-','Color',[0.4940, 0.1840, 0.5560]);
...
axis([0, emax/2, -inf, 0.75])
    ...
    xlabel('\omega');
    ylabel('DOS');
    legend({'T=0', ['T=',num2str(Tv(Tcinds(4)),2)], ['T=',num2str(Tv(Tcinds(5)))],...
        ['T=',num2str(Tv(Tcinds(6)))],'T=\infty'}, 'Location', 'NorthEast');
    hold off;
...
hh=figure;%('Position',position);
    ...
    plot(Ev(bin),normalate( II{4}(Tcinds(1),bin) , 1/dE ),...
        Ev(bin),normalate( II{4}(Tcinds(2),bin) , 1/dE )...
        ,Ev(bin),normalate( II{4}(Tcinds(3),bin) , 1/dE ) );
    axis([0, emax, -inf, .24])
 %   caxis auto
    xlabel('\omega');
    ylabel('I_{xx}');
    legend({'T=0', ['T=',num2str(Tv(Tcinds(1)))], ['T=',num2str(Tv(Tcinds(2)))],...
        ['T=',num2str(Tv(Tcinds(3)))]}, 'Location', 'NorthEast');
    hold off;
