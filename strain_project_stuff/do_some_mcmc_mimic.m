...
problem.rmax = 7; %radius of honeycomb flake in plaquettes
...
%     %Save the data for plotting later
    save(['stretch_flux_mcmc_mimic1_rmax_',num2str(round(rmax)),'_b_',num2str(round(b)),'_s_',num2str(1000*s)]...
